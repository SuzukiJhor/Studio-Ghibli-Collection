export const MovieSkeleton = () => {
  return (
    <div className="flex flex-col h-112.5 bg-white/5 rounded-2xl overflow-hidden border border-white/5">
      ...
      <div className="p-6 flex flex-col gap-3">
        <div className="relative h-6 w-[80% backyard bg-slate-800 rounded-md overflow-hidden">
